...
def test_test01():
    arg1 = """Here is Nick's website: [[https://nick-ivanov.com]]((https://nick-ivanov.com))!"""

    result = sol.question01(arg1)
    expected = """Here is Nick's website: <a href='https://nick-ivanov.com'>https://nick-ivanov.com</a>!"""
    assert expected == result


def test_test02():
    arg1 = """You can find more information about MSU at MSU.EDU ([[https://msu.edu/]]((https://msu.edu/)))."""

    result = sol.question01(arg1)
    expected = """You can find more information about MSU at MSU.EDU (<a href='https://msu.edu/'>https://msu.edu/</a>)."""
    assert expected == result
